...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dbmail_signaldeferreddispatch', (
        ...
        db.send_create_signal('dbmail', ['SignalDeferredDispatch'])

        # Adding index on 'SignalDeferredDispatch', fields ['eta', 'done']
        db.create_index('dbmail_signaldeferreddispatch', ['eta', 'done'])


    def backwards(self, orm):
        # Removing index on 'SignalDeferredDispatch', fields ['eta', 'done']
        db.delete_index('dbmail_signaldeferreddispatch', ['eta', 'done'])

        # Deleting model 'SignalDeferredDispatch'
        db.delete_table('dbmail_signaldeferreddispatch')
    ...
    if VERSION >= (1, 5):
        models['dbmail.signaldeferreddispatch']['Meta'] = {'object_name': 'SignalDeferredDispatch', 'index_together': "(('eta', 'done'),)"}
    else:
        models['dbmail.signaldeferreddispatch']['Meta'] = {'object_name': 'SignalDeferredDispatch'}
